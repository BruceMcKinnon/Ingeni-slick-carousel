<?php 
//
// Post preview template for Ingeni Slick Slider
//

function do_slick_template( $this_post ) {
	try {

		$retHtml = '<div class="slick-template-wrap post-preview">';
		...
		$retHtml = '<p>do_slick_template: '.$ex->getMessage().'</p>';
	}
